...
#define HW_I2C_SDA                      (GPIO_NUM_5)
#define HW_I2C_SCL                      (GPIO_NUM_4)
#define TOUCH_CONTROLLER_NAME           "FT5x06"
#define TOUCH_ROTATION_TYPE             TOUCH_ROTATION_STANDARD
#define TOUCH_CONTROLLER_TYPE_FT5x06    1
...
#if defined(TOUCH_CONTROLLER_TYPE_FT5x06)

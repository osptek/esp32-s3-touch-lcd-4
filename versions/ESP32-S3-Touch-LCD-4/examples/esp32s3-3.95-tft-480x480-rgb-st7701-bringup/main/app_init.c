...
void app_init(void)
{
...
#if CONFIG_EXAMPLE_LCD_TOUCH_CONTROLLER_FT6336U
    ESP_LOGI(TAG, "Initialize I2C bus (FT6336U)");
    ...
    ESP_ERROR_CHECK(esp_lcd_touch_new_i2c_ft6x36(tp_io_handle, &tp_cfg, &tp_handle));
#else
    ESP_LOGI(TAG, "FT6336U touch disabled in menuconfig");
#endif

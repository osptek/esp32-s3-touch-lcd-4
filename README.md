...
<h1 align="center">OSPTEK ESP32-S3-Touch-LCD-4 系列</h1>

<p align="center"><b>4 寸触摸面板 · 多版本索引 · ESP32-S3</b></p>
...
本仓库收录 **ESP32-S3-Touch-LCD-4 系列** 4 寸触摸屏面板成品资料。

**根目录 README 为导航页**。下表可快速浏览各版本；点击「完整资料」进入 `versions/` 下对应**型号文件夹**（产品页、规格书、示例、固件均在该目录内）。

仓库名：`esp32-s3-touch-lcd-4`
...
**说明：** 旧版硬件（ESP32-TPCB4）；USB 5V / 12–24 VDC；一路 RS485。

完整产品页、规格书与示例：[versions/ESP32-S3-Touch-LCD-4/](./versions/ESP32-S3-Touch-LCD-4/)
...
**说明：** 新版 Pro；在 Classic 基础上增加板载音频（ES8311 + NS4150B）。

完整产品页、规格书与示例：[versions/ESP32-S3-Touch-4-Pro/](./versions/ESP32-S3-Touch-4-Pro/)
...
**说明：** 220V 交流供电版（AC 85–265 V）；一路 RS485。

完整产品页、规格书与示例：[versions/ESP32-S3-Touch-4-220V/](./versions/ESP32-S3-Touch-4-220V/)

---

## 外壳 CAD

本系列 **86 型外壳**（2 层 / 4 层）全型号通用。
